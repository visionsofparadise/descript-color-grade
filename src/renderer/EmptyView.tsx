			...
			<div className="flex-1 flex items-center justify-center">
				<div className="flex flex-col items-center gap-4">
					...
					<div className="flex gap-2">
						<Button type="button" variant="ghost" size="sm" onClick={onNewProject} className="text-neutral-200 hover:text-neutral-100">
							<FilePlus aria-hidden="true" />
							New Project
						</Button>
						<Button type="button" variant="ghost" size="sm" onClick={onOpenProject} className="text-neutral-200 hover:text-neutral-100">
